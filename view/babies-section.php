...
<section class="hero-banner text-white d-flex align-items-center" style="background: url('pic/top-trend.jpg') center/cover no-repeat; height: 450px;">
  <div class="container text-center">
    <h1 class="display-4 fw-bold">Explore the Joy of Childhood</h1>
    <p class="lead mb-4">Playful styles, colorful outfits, and comfy clothes made just for your little ones.</p>
    <a href="#shop-now" class="btn btn-danger btn-lg px-4">Shop Kids' Collection</a>
  </div>
</section>
  ...
  <h2 class="mb-4 text-center">Hats For Your Toddler</h2>
  <div class="row g-3">
    
    <div class="col-6 col-md-4 col-lg-3">
      <div class="product-card">
        <div class="product-img">
          <img src="pic/child0.jpg" alt="Lofty Crew Neck Knit" class="img-fluid">
        </div>
   ...
   <div class="col-6 col-md-4 col-lg-3">
      <div class="product-card">
        <div class="product-img">
           <img src="pic/child2.jpg" alt="Lofty Crew Neck Knit" class="img-fluid">
        </div>
        <div class="product-info text-center mt-3">
          <div class="product-title">Lofty Crew Neck Knit</div>
          <div class="product-subtext">In 3 Colours</div>
   ...
   <div class="col-6 col-md-4 col-lg-3">
      <div class="product-card">
        <div class="product-img">
            <img src="pic/child3.jpg" alt="Lofty Crew Neck Knit" class="img-fluid">
        </div>
        <div class="product-info text-center mt-3">
          <div class="product-title">Lofty Crew Neck Knit</div>
          <div class="product-subtext">In 3 Colours</div>
 ...
 <div class="col-6 col-md-4 col-lg-3">
      <div class="product-card">
        <div class="product-img">
      <img src="pic/child4.jpg" alt="Lofty Crew Neck Knit" class="img-fluid">
        </div>
        <div class="product-info text-center mt-3">
          <div class="product-title">Lofty Crew Neck Knit</div>
          <div class="product-subtext">In 3 Colours</div>
   ...
   <div class="col-6 col-md-4 col-lg-3">
      <div class="product-card">
        <div class="product-img">
         <img src="pic/child5.jpg" alt="Lofty Crew Neck Knit" class="img-fluid">
        </div>
        <div class="product-info text-center mt-3">
          <div class="product-title">Lofty Crew Neck Knit</div>
          <div class="product-subtext">In 3 Colours</div>
...
<div class="col-6 col-md-4 col-lg-3">
      <div class="product-card">
        <div class="product-img">
           <img src="pic/child6.jpg" alt="Lofty Crew Neck Knit" class="img-fluid">
        </div>
        <div class="product-info text-center mt-3">
          <div class="product-title">Lofty Crew Neck Knit</div>
          <div class="product-subtext">In 3 Colours</div>
