...
<div class="secondary-nav bg-white border-bottom">
 ...
 <style>
    .hero-section {
      background: url('https://images.unsplash.com/photo-1523275335684-37898b6baf30?fit=crop&w=1600&q=80') no-repeat center center;
...
<div class="container py-5">
  ...
  <div class="filter-buttons mb-4">
    <button class="btn btn-outline-dark"id="watch-btn-id">Smart Watch</button>
    <button class="btn btn-outline-dark"id="watch-btn-id">Wristwatch</button>
    <button class="btn btn-outline-dark"id="watch-btn-id">Time</button>
    <button class="btn btn-outline-dark"id="watch-btn-id">Watches</button>
    <button class="btn btn-outline-dark"id="watch-btn-id">Clock</button>
    <button class="btn btn-outline-dark"id="watch-btn-id">Rolex</button>
    <button class="btn btn-outline-dark"id="watch-btn-id">Grey</button>
    <button class="btn btn-outline-dark"id="watch-btn-id">Product</button>
  </div>

  <!-- Masonry Grid -->
  <div class="masonry">
    <div class="masonry-item">
      <img src="pic/1.jpg" alt="Watch 1">
    </div>
    <div class="masonry-item">
      <img src="pic/2.jpg" alt="Watch 2">
    </div>
    <div class="masonry-item">
       <img src="pic/3.jpg" alt="Watch 3">
    </div>
    <div class="masonry-item">
       <img src="pic/4.jpg" alt="Watch 1">
    </div>
    <div class="masonry-item">
<img src="pic/5.jpg" alt="Watch 1">
    </div>
    <div class="masonry-item">
   <img src="pic/6.jpg" alt="Watch 1">
    </div>
  </div>
</div>
  ...
  <section class="hero-section">
    <div class="hero-overlay text-center">
      <h1 class="display-4 fw-bold">Timeless Elegance</h1>
      <p class="lead">Discover luxury watches that complete your look</p>
      <a href="#collection" class="btn btn-light btn-lg mt-3">Explore Collection</a>
    </div>
  </section>
  ...
  <section id="collection" class="py-5">
    <div class="container">
      <h2 class="text-center mb-4 fw-bold">Featured Watches</h2>
      <div class="row g-4">
        <div class="col-md-4">
          <div class="card watch-card">
            <img src="https://images.unsplash.com/photo-1600180758890-4b9e6c7e8b3d?fit=crop&w=600&q=80" class="card-img-top" alt="Watch 1">
        ...
        <div class="col-md-4">
          <div class="card watch-card">
            <img src="https://images.unsplash.com/photo-1600180758743-3a2d4f09edb1?fit=crop&w=600&q=80" class="card-img-top" alt="Watch 2">
            <div class="card-body text-center">
              <h5 class="card-title">Stainless Steel Chrono</h5>
        ...
        <div class="col-md-4">
          <div class="card watch-card">
            <img src="https://images.unsplash.com/photo-1611858263296-9cf94c4c1c7f?fit=crop&w=600&q=80" class="card-img-top" alt="Watch 3">
            <div class="card-body text-center">
              <h5 class="card-title">Minimal Matte Black</h5>
