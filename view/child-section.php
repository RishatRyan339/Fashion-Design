...
<section class="hero-banner text-white d-flex align-items-center" style="background: url('pic/bkid.jpg') center/cover no-repeat; height: 450px;">
  ...
  <h2 class="mb-4 text-center">Kids's Collection</h2>
  <div class="row g-3">
