...
document.getElementById('close-btn').addEventListener('click', function() {
 ...
 <section class="custom-container my-5"id="container-id">
  <h2 class="mb-4 text-center">Teenager's Collection</h2>
  <div class="row g-3">
    
    <div class="col-6 col-md-4 col-lg-3">
      <div class="product-card">
        <div class="product-img">
          <img src="pic/teen1.jpg" alt="Lofty Crew Neck Knit" class="img-fluid">
        </div>
   ...
   <div class="col-6 col-md-4 col-lg-3">
      <div class="product-card">
        <div class="product-img">
          <img src="pic/teen2.jpg" alt="Lofty Crew Neck Knit" class="img-fluid">
        </div>
        <div class="product-info text-center mt-3">
          <div class="product-title">Lofty Crew Neck Knit</div>
          <div class="product-subtext">In 3 Colours</div>
   ...
   <div class="col-6 col-md-4 col-lg-3">
      <div class="product-card">
        <div class="product-img">
     <img src="pic/teen3.jpg" alt="Lofty Crew Neck Knit" class="img-fluid">
        </div>
        <div class="product-info text-center mt-3">
          <div class="product-title">Lofty Crew Neck Knit</div>
          <div class="product-subtext">In 3 Colours</div>
 ...
 <div class="col-6 col-md-4 col-lg-3">
      <div class="product-card">
        <div class="product-img">
     <img src="pic/teen4.jpg" alt="Lofty Crew Neck Knit" class="img-fluid">
        </div>
        <div class="product-info text-center mt-3">
          <div class="product-title">Lofty Crew Neck Knit</div>
          <div class="product-subtext">In 3 Colours</div>
   ...
   <div class="col-6 col-md-4 col-lg-3">
      <div class="product-card">
        <div class="product-img">
        <img src="pic/teen5.jpg" alt="Lofty Crew Neck Knit" class="img-fluid">
        </div>
        <div class="product-info text-center mt-3">
          <div class="product-title">Lofty Crew Neck Knit</div>
          <div class="product-subtext">In 3 Colours</div>
...
<section class="fashion-banner4">
  <div class="banner-image4">
    <img src="pic/acc1.jpg" alt="Wearable Accessories">
  </div>
...
<section class="banner-bg d-flex align-items-center justify-content-center text-white"id="lp-bg">
    <div class="text-center  bg-opacity-50 p-5 rounded"id="hero-head3">
      <h2 class="display-4 mb-3" id="kids-her">Want gifts for your teenager?</h2>
     
      <a href="gifts.php" id="hero-btn"class="btn btn-light text-dark">Click here </a>
    </div>
  </section>
   <!--------------------------------------------  KIDS -------------------------------------------------- SECTION ------->
  <!--------------------------------------------  NEWS -------------------------------------------------- Letter ------->
