 ...
 <section class="custom-container my-5"id="container-id">
  ...
  <div class="row g-3">
    ...
    <div class="col-6 col-md-4 col-lg-3">
      <div class="product-card">
        <div class="product-img">
          <img src="pic/s1.jpg" alt="Lofty Crew Neck Knit" class="img-fluid">
        </div>
   ...
   <div class="col-6 col-md-4 col-lg-3">
      <div class="product-card">
        <div class="product-img">
          <img src="pic/f3.jpg" alt="Lofty Crew Neck Knit" class="img-fluid">
        </div>
        <div class="product-info text-center mt-3">
          <div class="product-title">Lofty Crew Neck Knit</div>
          <div class="product-subtext">In 3 Colours</div>
   ...
   <div class="col-6 col-md-4 col-lg-3">
      <div class="product-card">
        <div class="product-img">
          <img src="pic/fer.jpg" alt="Lofty Crew Neck Knit" class="img-fluid">
        </div>
        <div class="product-info text-center mt-3">
          <div class="product-title">Lofty Crew Neck Knit</div>
          <div class="product-subtext">In 3 Colours</div>
...
<section class="container my-5">
  ...
  <div class="row g-4">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      <div class="women-fashion-card">
        <img src="pic/f3.jpg" alt="Elegant Dress" class="img-fluid">
        <div class="women-card-details">
          <div class="women-card-title">Elegant Dress</div>
          <div class="women-card-price">$49.99</div>
          <button class="btn btn-secondary women-card-button mt-2">Add to Cart</button>
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      <div class="women-fashion-card">
        <img src="pic/f2.jpg" alt="Casual Wear" class="img-fluid">
        <div class="women-card-details">
          <div class="women-card-title">Casual Wear</div>
          <div class="women-card-price">$39.99</div>
          <button class="btn btn-primary women-card-button mt-2">Add to Cart</button>
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      <div class="women-fashion-card">
        <img src="pic/f1.jpg" alt="Summer Outfit" class="img-fluid">
        <div class="women-card-details">
          <div class="women-card-title">Summer Outfit</div>
          <div class="women-card-price">$59.99</div>
          <button class="btn btn-primary women-card-button mt-2">Add to Cart</button>
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      <div class="women-fashion-card">
        <img src="pic/fe7.jpg" alt="Summer Outfit" class="img-fluid">
        <div class="women-card-details">
          <div class="women-card-title">Summer Outfit</div>
          <div class="women-card-price">$59.99</div>
          <button class="btn btn-primary women-card-button mt-2">Add to Cart</button>
...
<section class="fashion-banner">
  <div class="banner-image">
    <img src="pic/bags.jpg" alt="Bags Collection">
  </div>
...
<section class="banner-bg d-flex align-items-center justify-content-center text-white"id="banner-bg-female">
    <div class="text-center  bg-opacity-50 p-5 rounded"id="hero-head32">
      <h2 class="display-4 mb-3" id="female-her">Want some lipstick shades?</h2>
